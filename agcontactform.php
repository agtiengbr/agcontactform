...
class agcontactform extends Module implements WidgetInterface
{
    /** @var string */
    ...
    protected function renderForm()
    {
        ...
        $form = [
            'form' => [
                'description' => 'Para o funcionamento correto do módulo edite o arquivo '._THEME_DIR_.'templates/contact.tpl de {widget name="contactform"} para {widget name="agcontactform}',
                'legend' => [
    ...
    public function sendMessage()
    {
        ...
        Hook::exec('displayBeforeContactFormSubmitButton',['g-recaptcha-response'=>Tools::getValue('g-recaptcha-response')]);
